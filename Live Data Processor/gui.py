...
class SensorDashboard(QMainWindow):
    ...
    def show_pinout_map(self) -> None:
        ...
        pinout_rows = [
            ["Apogee O₂", "Positive signal", "Waveshare ADC AD0", "mV", "Differential positive input"],
            ["Apogee O₂", "Negative signal", "Waveshare ADC AD1", "mV", "Differential negative input"],
            ["ZAB 1", "Voltage sense", "Waveshare ADC AD2", "mV", "Used for ZAB 1 current calculation"],
            ["ZAB 2", "Voltage sense", "Waveshare ADC AD3", "mV", "Used for ZAB 2 current calculation"],
            ["ZAB 3", "Voltage sense", "Waveshare ADC AD4", "mV", "Used for ZAB 3 current calculation"],
    ...
    def read_update(self) -> None:
        ...
        print(row)
        print("Selected plot keys:", self.selected_plot_keys())
