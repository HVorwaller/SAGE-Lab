...
class WaveshareADCController:
    ...
    def read_all(self) -> Dict[str, Optional[float]]:
        return {
            "zab1_voltage_mV": self.read_voltage_mV(0),
            "zab2_voltage_mV": self.read_voltage_mV(1),
            "zab3_voltage_mV": self.read_voltage_mV(2),
            "apogee_voltage_V": None if self.read_voltage_mV(3) is None else self.read_voltage_mV(3) / 1000.0,
        }
